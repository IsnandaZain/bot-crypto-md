...
class MTFConfluence:
    ...
    def analyze(self):
        ...
        # 🔹 OPSI B: ALLOW WITH PENALTY (Aktifkan baris ini jika ingin tetap trade counter-trend)
        # reasons.append("DIVERGENCE WARNING — 1H dan 15m berlawanan, confidence dipangkas 30%")
        # total_score *= 0.7
        # # Jangan return, lanjutkan ke eksekusi
